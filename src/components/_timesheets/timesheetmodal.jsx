...
const TimesheetModal = ({ isOpen, onClose, onSave, editData, onDelete }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-800/75 flex items-center justify-center p-3 sm:p-4">
                ...
                <div className="flex-shrink-0 flex justify-between items-center pb-4 border-b border-gray-100 mb-6">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="text-slate-400 hover:text-[#1742c4] transition-colors p-1"
                        >
                            <RefreshCw className="w-6 h-6" />
                        </button>
                        <button
                            onClick={onClose}
                            className="text-[#F5B52A] hover:text-red-500 transition-colors p-1"
                        >
                            <X className="w-8 h-8" />
                        </button>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100 md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="date" name="timesheet_date" value={formData.timesheet_date} onChange={handleChange} required className="w-full p-2 border border-blue-200 rounded-md" />
                        </div>
                                    ...
                                    <div className="absolute left-0 right-0 mt-1 bg-white border border-blue-200 rounded-lg overflow-hidden shadow-lg z-50 max-h-48 overflow-y-auto">
                                        {filteredClients.map((client) => (
                                            <div
                                                ...
                                                className={`px-3 py-2 cursor-pointer text-xs hover:bg-blue-50 flex items-center justify-between ${selectedClient?.client_id === client.client_id ? "bg-blue-100" : ""}`}
                                            >
                    ...
                    <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100 md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="text" name="transaction_code" value={formData.transaction_code} onChange={handleChange} placeholder="Enter transaction code" className="w-full p-2 border border-blue-200 rounded-md" />
                        </div>
                        <div className="flex flex-col">
                ...
                <div className="border-t border-slate-200 mt-6 flex-shrink-0">
                    <div className="px-4 sm:px-6 md:px-8 py-4 flex flex-col-reverse sm:flex-row justify-end items-center gap-3">
                        <button
                            type="button"
                            onClick={onClose}
                            className="w-full sm:w-auto px-5 py-2.5 text-sm font-semibold text-slate-700 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors min-h-[44px]"
                        >
                            Cancel
                        </button>
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full sm:w-auto px-5 py-2.5 bg-[#1742c4] hover:bg-[#4F46E5] text-white text-sm font-bold rounded-lg shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]"
                        >
