        ...
        <div className="w-full flex flex-col gap-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-2">
                ...
                <div className="flex items-center gap-3 bg-white p-1 rounded-xl shadow-sm border border-slate-100">
                    <button className="px-4 py-2 text-xs font-semibold text-slate-600 rounded-lg hover:bg-slate-50 transition-colors">
                        Costing History
                    </button>
                    <button className="px-4 py-2 text-xs font-semibold text-white bg-indigo-600 rounded-lg shadow-sm hover:bg-indigo-700 transition-colors">
                        New Run
                    </button>
                </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-xl shadow-slate-100/60 border border-slate-100">
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    <div className="flex items-start gap-4 flex-1">
                        <DocumentIcon />
                        <div>
                            <h2 className="text-lg font-bold text-slate-800">Export Controls</h2>
                            <p className="text-xs text-slate-400 mt-0.5 max-w-sm">
                                Select a client name and cost code structure to generate standard costing schedules and billing projections.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
                        ...
                        <div className="flex flex-col gap-1.5 flex-1 min-w-[200px]">
                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1">Client Business Unit</label>
                        ...
                        <div className="flex flex-col gap-1.5 flex-1 min-w-[180px]">
                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1">Cost Code Bracket</label>
                            <div className="relative">
                                <select
