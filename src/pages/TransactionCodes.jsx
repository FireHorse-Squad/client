                        ...
                        <table className="w-full border-separate border-spacing-0 table-fixed select-text">
                            ...
                            <tbody className="divide-y divide-slate-200">
                                {paginatedData.length > 0 ? paginatedData.map((row, rowIndex) => {
                                    ...
                                    <tr><td colSpan={COLUMNS.length + 2} className="py-16 text-center text-slate-400 bg-white"><div className="flex flex-col items-center justify-center"><div className="text-slate-300 text-5xl mb-3">📭</div><p className="text-base font-semibold text-slate-500">No transaction codes found</p></div></td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
